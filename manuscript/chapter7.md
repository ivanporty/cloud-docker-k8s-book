# 8. Взаимодействие сервисов Kubernetes
...
```shell
$ gradle jib --image={ваша_учетная_запись_Docker}/weekend-service:0.1.0
```
