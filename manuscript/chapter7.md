...
Все так же используя терминал контейнера `busybox`, проверим, что и расширенные доменные имена с использованием пространств имен и суффиксов работают:
